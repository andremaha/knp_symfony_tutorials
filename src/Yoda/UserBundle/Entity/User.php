...
class User implements AdvancedUserInterface, Serializable
{
     ...
     * @Assert\NotBlank(message="When we don't know your name, we can't remember you!")
     * @Assert\Length(min=2, minMessage="[0, +Inf] Enter something longer then 2 characters")
    ...
    /**
     * Set roles for the user entity
     *
     * @param array $roles to set
     */
